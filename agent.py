...
client = Client(
  # Ollama Turbo
  host="https://eager-facts-work.loca.lt/", 
  ...
  if response.message.tool_calls:
    for tool_call in response.message.tool_calls:
      ...
      if function_to_call:
        ...
        tool_call_details = f'Result from tool call name: {tool_call.function.name} with arguments: {tool_call.function.arguments} result: {result}\n'
        messages.append({'role': 'tool', 'content': tool_call_details, 'tool_name': tool_call.function.name})
      else:
